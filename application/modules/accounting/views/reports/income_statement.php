...
<table class="table-simple" border="1" cellpadding="4" cellspacing="0">
    ...
    <?php foreach($accounts as $account): ?>
        ...
        <tr>
            <td><?=isset($account->code_number) ? $account->code_number : $account->account_map?></td>
    ...
    <tr>
        ...
        <td class="right-text bold border-bottom"><?=to_currency($total_income)?></td>
    </tr>
    ...
    <tr>
        ...
        <td class="right-text bold border-bottom"><?=to_currency($total_expenses)?></td>
    </tr>
