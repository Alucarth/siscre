...
<div class="title-block">
    <h3 class="title"> 
        <span style="float:left">List of Income Account</span>
    </h3>

    <div style="clear:both;"></div>

    <p class="title-description">
        Add, update & delete income accounts
    </p>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:600px">
            <div class="modal-header">
                Liability
                <input type="hidden" name="account_type" id="account_type" value="income" />
            </div>
...
<script>
    $(document).ready(function () {
        $("#tbl_accounts_filter").prepend("<a href='javascript:void(0)' class='btn btn-primary pull-left' id='btn-new-asset'>New income account</a>");
        ...
        $("#btn-save-asset").click(function(){
            ...
            var params = $("#md-income input, #md-income textarea").serialize();
        ...
        $(document).on("click", ".btn-delete", function () {
            var $this = $(this);
            alertify.confirm("Are you sure you wish to delete this income account?", function () {
