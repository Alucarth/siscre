...
<div class="title-block">
    <h3 class="title"> 
        <span style="float:left">List of Equity Accounts</span>
    </h3>

    <div style="clear:both;"></div>

    <p class="title-description">
        Add, update & delete equity accounts
    </p>
</div>
...
<script>
    $(document).ready(function () {
        $("#tbl_accounts_filter").prepend("<a href='javascript:void(0)' class='btn btn-primary pull-left' id='btn-new-asset'>New equity account</a>");
