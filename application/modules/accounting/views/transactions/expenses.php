                        ...
                        <table class="table table-hover table-bordered" id="tbl_expenses">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Factura/Recibo <br/>numero</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:600px">
            <div class="modal-header">
                 Egresos
                <input type="hidden" name="transaction_type" id="transaction_type" value="expenses" />
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Factura/Recibo numero:</label>
...
<script>
    $(document).ready(function () {
        $("#tbl_expenses_filter").prepend("<a href='javascript:void(0)' class='btn btn-primary pull-left' id='btn-new-expenses'>Crear</a>");
        ...
        $("#btn-save-expenses").click(function(){
            ...
            var params = $("#md-expenses input, #md-expenses textarea, #md-expenses select").serialize();
        ...
        $(document).on("click", ".btn-delete", function () {
            var $this = $(this);
            alertify.confirm("Esta seguro que desea eliminar este egreso?", function () {
