                        ...
                        <table class="table table-hover table-bordered" id="tbl_asset">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Importe valor</th>
                                    <th style="text-align: center">Fecha de compra</th>
                                    <th style="text-align: center">Cantidad adquirida</th>
                                    <th style="text-align: center">Importe de depreciacion</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:600px">
            <div class="modal-header">
                 Activo
                <input type="hidden" name="transaction_type" id="transaction_type" value="asset" />
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        <span class="input-group-addon input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span></span>
                        <input type="text" id="purchased_date" name="purchased_date" class="form-control" value="" />
                    </div>
                </div>
                <div class="form-group">
                    <label>Cantidad adquirida:</label>
                    <input type="text" class="form-control" name="purchased_amount" id="purchased_amount" />
                </div>
                <div class="form-group">
                    <label>Importe de depreciacion:</label>
                    <input type="text" class="form-control" name="depreciate_amount" id="depreciate_amount" />
                </div>
                <div class="form-group">
...
<script>
    $(document).ready(function () {
        $("#tbl_asset_filter").prepend("<a href='javascript:void(0)' class='btn btn-primary pull-left' id='btn-new-asset'>Crear</a>");
        ...
        $("#btn-save-asset").click(function(){
            ...
            var params = $("#md-asset input, #md-asset textarea, #md-asset select").serialize();
        ...
        $(document).on("click", "#btn-new-asset", function(){            
            $("#md-asset .modal-body input, #md-asset .modal-body textarea").val("");
