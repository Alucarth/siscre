    ...
    <div class="modal-dialog">
        <div class="modal-content" style="width:600px">
            <div class="modal-header">
                 Patrimonio
                <input type="hidden" name="transaction_type" id="transaction_type" value="equity" />
            </div>
...
<script>
    $(document).ready(function () {
        $("#tbl_equity_filter").prepend("<a href='javascript:void(0)' class='btn btn-primary pull-left' id='btn-new-equity'>Crear</a>");
        ...
        $("#btn-save-equity").click(function(){
            ...
            var params = $("#md-equity input, #md-equity textarea, #md-equity select").serialize();
