...
<script>
    $(document).ready(function () {
        ...
        $(document).on("click", ".btn-activate", function () {
            var $this = $(this);
            alertify.confirm("¿Estás seguro de que deseas activar este complemento?", function () {
        ...
        $(document).on("click", ".btn-uninstall-plugin", function () {
            var $this = $(this);
            alertify.confirm("¿Estás seguro de que deseas desinstalar este complemento?", function () {
        ...
        $(document).on("click", ".btn-deactivate", function () {
            var $this = $(this);
            alertify.confirm("¿Estás seguro de que deseas desactivar este complemento?", function () {
        ...
        $("#plugin_manager_wrapper .dt-buttons.btn-group").html("<div><button class='btn btn-primary pull-left' id='btn-browse-plugin'>Navegar</button> &nbsp;<div class='pull-left' style='margin-left: 5px;' id='basic_progress'></div><div id='basic_message' style='margin-left:5px;'></div></div>");
