...
<?= form_open('leads/employee/' . $person_info->person_id, array('id' => 'customer_form', 'class' => 'form-horizontal')); ?>
                            ...
                            <div class="tabs-container">
                                ...
                                <div class="tab-content">
                                    <div id="sectionA" class="tab-pane fade in active show">
                                        ...
                                        <?php $this->load->view("leads/front/secure/employees/form_basic_info"); ?>                                        
                                    </div>
                                    ...
                                    <div id="tab-acc-statement" class="tab-pane fade">
                                        <?php $this->load->view('leads/front/secure/account_statements');?>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function post_person_form_submit(response)
        {
            ...
            {
                window.location.href = '<?=site_url("leads/employee/")?>' + response.person_id; 
            }
        }
    });
</script>