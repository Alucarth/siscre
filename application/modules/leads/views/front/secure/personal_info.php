...
<?= form_open('leads/save_profile/' . $person_info->person_id, array('id' => 'customer_form', 'class' => 'form-horizontal')); ?>
                        ...
                        <div class="inqbox-content">
                            <div class="tabs-container">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bordered">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-company">Company Information</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-documents">Verification Documents</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-bank">Bank Information</a></li>
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-acc-statement">Acc. Statements</a></li>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function post_person_form_submit(response)
        {
            ...
            {
                window.location.href = '<?=site_url("leads/personal_info/")?>';
            }
        }
    });
</script>