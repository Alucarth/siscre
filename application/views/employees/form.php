...
<div class="title-block">
    <h3 class="title"> 
        ...
        <?php if ($person_info->person_id > 0): ?>
            <?=ktranslate("employees_update");?>
        <?php else: ?>
            <?=ktranslate("employees_new");?>
        <?php endif; ?>

    </h3>
    <p class="title-description">
        <?=ktranslate("employees_basic_information");?>
    </p>
</div>
                        ...
                        <div class="inqbox-content">
                            ...
                            <div class="tabs-container">
                                <ul class="nav nav-tabs nav-tabs-bordered">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#tab-personal-details"><?= ktranslate("customers_personal_information");?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#tab-credentials"><?=ktranslate("employees_permission_info");?></a>
                                    </li>
                                </ul>
                                <div class="tab-content tabs-bordered">
                                    ...
                                    <div id="tab-credentials" class="tab-pane fade in">
                                        ...
                                        <?php if(is_plugin_active("branches")):?>
                                            <div class="form-group row">
                                                <label class="control-label col-sm-2 text-xs-right" style="color:red">
                                                    <?= ktranslate("branches_branches")?>:
                                                </label>
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="branch_ids[]" id="branch_ids" multiple="multiple">
                                                        <?php foreach ($branches as $branch): ?>
                                                            <option value="<?= $branch->id; ?>" <?= (in_array($branch->id, $branch_ids)) ? "selected='selected'" : ""; ?>><?= $branch->branch_name; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <div>
                            ...
                            <?php if ( $person_info->person_id > 0 ): ?>
                                <?php if ( check_access($user_info->role_id, "employees", 'edit') ): ?>
                                ...
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if ( check_access($user_info->role_id, "employees", 'add') ): ?>
    ...
    $(document).ready(function () {
        ...
        var settings = {
            ...
            messages: {
                ...
                password: {
                    ...
                    minlength: "Las contrase&ntilde;as deben tener al menos 8 caracteres"
                },
                repeat_password: {
        ...
        function post_person_form_submit(response)
        {
            ...
            else
            {
                ...
                window.location.href = '<?=site_url("employees/view/")?>' + response.person_id; 
            }
        }
    });
</script>
